...
arith_examples.each do |ex|
  puts "#{ugly_print_arith(ex)}", "=", "ugly_print_arith(#{ex})", ""
end

cond_examples.each do |ex|
...
arith_examples.each { |ex| puts "#{pretty_print_arith(ex)}", "=", "#{ugly_print_arith(ex)}", "" }
cond_examples.each { |ex| puts "#{pretty_print_cond(ex)}", "=", "#{ugly_print_cond(ex)}", "" }
