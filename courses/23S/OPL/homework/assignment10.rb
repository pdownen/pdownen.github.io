...
# looking like:
#
#     M ::= ... | function f(x) = M in M

# The idea behind the recursive function `function f(x) = M in M'` is
# that it introduces a local function named f which is visible in BOTH
# the body of the block of code `M'` as well as the body `M` of the
...
#
#   1. Represent a recursive function (function f(x) = M in M') as
#
