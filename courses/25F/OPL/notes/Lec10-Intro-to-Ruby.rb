...
# Alternatively, you can use a `for` loop, which automatically calls the `each`
# method for you.
...
# Again, the same loop can be written in two different ways

for index, value in alpha_num
  puts "#{index} => #{value}"
end
